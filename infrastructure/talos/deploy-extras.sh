...
envsubst < ../../../kubernetes/talos/apps/kube-system/cilium/app/values.yaml  > cni/values.yaml
...
envsubst < ../../../kubernetes/talos/apps/kube-system/kubelet-csr-approver/app/values.yaml > csr-approver/values.yaml
